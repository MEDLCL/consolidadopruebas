...
-- Tiempo de generación: 13-10-2021 a las 01:28:18
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `rptcalculo` ()  NO SQL
...
(80, 4, 58, 59, 'SERCOGUA CR', 'SERVICIOS COMERCIALES DE GUATEMALA COSTARICA', '56231', 'CIUDAD COSTARICA', '50623037000', 'CO', '1', 1, 0, 'cbm', '2021-08-12 06:00:00'),
(81, 4, 58, 59, 'CLIENTE 1 DE COSTARICA', 'CLIENTE 1 DE COSTARICA', '698574', 'CIUDAD DE COSTARICA', '4569852', 'CL', '1', 1, 0, 'cbm', '2021-08-12 06:00:00'),
(82, 4, 58, 59, 'CTM', 'CTM', '59874', 'COSTA RICA', '1236548', 'CO', '2', 1, 0, 'tarifa', '2021-08-24 15:43:58'),
(83, 4, 58, 47, 'LEADER GROUP', 'LEADER', '2365458', 'CHINA', '115698854', 'AE', '1', 1, 0, '', '2021-09-02 15:44:15'),
(84, 4, 58, 111, 'ONE', 'ONE', '45698', 'JAPON', '458789', 'AE', '2', 1, 0, '', '2021-09-02 16:39:00'),
(85, 4, 58, 100, 'LEADER OCEAN', 'LEADER OCEAN', '45896', 'HONG KONG', '5987', 'NA', '1', 1, 0, '', '2021-09-02 16:44:27'),
(86, 4, 58, 73, 'EMPRESA DE COLOADER', 'EMPRESA DE COLOADER', '120393918', 'ESPA&Ntilde;A', '101928948', 'AC', '1', 1, 0, '', '2021-09-02 16:59:48');
...
--
ALTER TABLE `archivos_embarques`
  MODIFY `id_archivos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `asigna_menu`
--
ALTER TABLE `asigna_menu`
  MODIFY `idasigna_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;
...
--
ALTER TABLE `consecutivos`
  MODIFY `id_consecutivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `contenedor`
  MODIFY `id_contenedor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `correlativoagente`
--
ALTER TABLE `correlativoagente`
  MODIFY `id_correlativo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `embarque_maritimo`
  MODIFY `id_embarque_maritimo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
