                                        ...
                                        <div class="box-body">
                                            <div class="col-md-12">
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" name="codigobarco" id="codigobarco"
                                                        class="form-control input-sm" readonly>
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="consecutivoBarco"
                                                        class="control-label">Consecutivo:</label>
                                                    <input type="text" name="consecutivoBarco" id="consecutivoBarco"
                                                        class="form-control input-sm" readonly>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="barcoLlegada" class="">Barco de Llegada(*)</label>
                                                    <div class="input-group input-group-sm">
                                                        <select id="barcoLlegada" name="barcoLlegada"
                                                            class="form-control selectpicker" data-live-search="true">
                                                        </select>
                                                        <span class="input-group-btn">
                                                            <button type="button" class="btn btn-success fa fa-plus"
                                                                data-target="#modalBarco"
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="ViajeLlegada" class="control-label">Viaje de
                                                        Llegada(*):</label>
                                                    <input type="text" class="form-control input-sm" id="ViajeLlegada"
                                                        name="ViajeLlegada" onkeyup="mayusculas(this)">
                                                </div>
                                                ...
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">ETD(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">ETA(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">CETA(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">ETANaviera(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">Completo(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">Piloto(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">Descarga(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">Liberado(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <label for="fechaingreso" class="control-label">Devuelto(*):</label>
                                                    <input type="text" id="fechaingreso" name="fechaingreso"
                                                        class="form-control input-sm">
                                                </div>
                                            </div> <!-- col md 8 tabla -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="number" class="form-control input-sm" id="ViajeLlegada"
                                                        name="ViajeLlegada" onkeyup="mayusculas(this)">
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="obervaciones"
                                                        class="control-label">Observaciones:</label>
                                                    <textarea class="form-control input-sm" id="obervaciones"
                                                        name="obervaciones" rows="3"
                                    ...
                                    <div class="box box-primary" id="">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="button" class="btn btn-default fa fa-file-pdf-o">Nuevo</button>
                                                    <button type="button" class="btn btn-primary fa fa-floppy-o">Grabar</button>                                 
                                                </div>
