                        ...
                        <div class="box-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group input-group-sm">
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="codigoAlmacen" id="codigoAlmacen"
                                            readonly>
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-info fa fa-plus" data-toggle="modal"
                                            data-target="#modalempresa" onclick="nuevoConsignado()"></button>
                                    </span>
                                </div>
                                <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="cntClientes"
                                                id="cntClientes">
                                        </div>
                                        <!-- /input-group -->
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <button class="btn btn-primary" type="button" onclick="grabarAlmacen()"
                                            id="grabaAlmacen">Graba
                                            <span class="fa fa-floppy-o"></span>
                                        </button>
                                        <button class="btn btn-danger" type="button" onclick="ocultaAlma(false)"
                                            id="cancelarA">Cancelar
        ...
        <div class="col-md-8">
                ...
                <div class="box-body">
                    <form class="" id="formAlmacenDetalle">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                <select id="embalajeD" name="embalajeD" class="form-control selectpicker"
                                    data-live-search="true">
                                </select>
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-info fa fa-plus" data-toggle="modal"
                                        data-target="#modalEmaqpue" onclick="limpiaEmpaque()"></button>
                                </span>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <fieldset class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-1 col-md-11">
                                    <button class="btn btn-primary" type="button" onclick="grabaDetalle()"
                                        id="grabaD">Grabar
                                        <span class="fa fa-floppy-o"></span>
                                    </button>
                                    <button class="btn btn-danger" type="button" onclick="nuevoDetalle('false')"
                                        id="cancelarD">Cancelar
                                        <span class="fa fa-close"></span>
                                    </button>
                                </div>
                            </div>
            ...
            <div id="tablaDetalleAlmacen">
                <div class="box box-solid">
                    <div class=" box-header with-border">
                        <button type="button" class="btn btn-primary" onclick="nuevoDetalle('true')"
                            id="btnNuevoDetalle">Nuevo
